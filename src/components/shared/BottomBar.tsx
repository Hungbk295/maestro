  ...
  return (
    <div className="no-select flex py-2 gap-3 px-4">
      <button
        ...
        disabled={inGridView}
        className={`flex items-center w-[180px] gap-2 rounded-lg border border-maestro-border bg-maestro-card px-4 py-1.5 text-xs font-medium shadow-md shadow-black/20 transition-colors ${
          inGridView
      ...
      {inGridView && (
        <button
          ...
          className="flex items-center gap-2 w-[130px] rounded-lg border border-maestro-border bg-maestro-card px-4 py-1.5 text-xs font-medium shadow-md shadow-black/20 transition-colors text-maestro-text hover:bg-maestro-border/50 disabled:cursor-not-allowed disabled:opacity-50"
        >
          <Plus size={13} />
          Add Session
        </button>
      ...
      {hasRunningSessions && (
        <button
          ...
          className="flex items-center gap-2 rounded-lg w-[120px] bg-maestro-red/90 px-4 py-1.5 text-xs font-medium text-white shadow-md shadow-black/20 transition-colors hover:bg-maestro-red disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <Square size={11} />
